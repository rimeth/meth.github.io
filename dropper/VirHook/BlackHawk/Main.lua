...
function Utility.InitAutoLoad(Window)
    Window:AutoLoadConfig("VirtualHook")
...
function Utility.ServerHop()
    ...
    if #Servers > 0 then
        ...
        VirtualHook.Utilities.UI:Notification({
            Title = "Virtual Hook Universal",
...
function Utility.SettingsSection(Self,Window,UIKeybind,CustomMouse)
    local OptionsTab = Window:Tab({Name = "Options"}) do
        ...
        OptionsTab:AddConfigSection("VirtualHook","Left")
    ...
    local VisualsTab = Window:Tab({Name = Name}) do
        ...
        if BoxEnabled then
            local BoxSection = VisualsTab:Section({Name = "Boxes",Side = "Left"}) do
                ...
                BoxSection:Slider({Name = "Thickness",Flag = Flag .. "/Box/Thickness",Min = 1,Max = 4,Value = 1})
        ...
        if HeadEnabled then
            local HeadSection = VisualsTab:Section({Name = "Head Dots",Side = "Right"}) do
                ...
                HeadSection:Slider({Name = "Size",Flag = Flag .. "/HeadDot/Size",Min = 1,Max = 100,Value = 15})
